-- 图书馆座位预约系统 MySQL 数据库初始化脚本 - UAT 环境

-- 创建数据库（使用 utf8mb4 字符集）
DROP DATABASE IF EXISTS library_booking_uat;
CREATE DATABASE library_booking_uat CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE library_booking_uat;
